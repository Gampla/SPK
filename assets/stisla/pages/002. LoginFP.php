...
<head>
  ...
  <title>Welcome to &mdash; Stisla</title>
      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <p class="text-muted">Sebelum membeli tiket lakukan registrasi akun terlebih dahulu yaa~💙 </p>
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Our Group. Made with 💙 by Group  
              <div class="mt-2">
